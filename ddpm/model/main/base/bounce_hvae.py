...
class LinearSubspaceBounceNetworkTeacherForcedHVAEReverseProcess(
    ...
    The above case is recovered** when membrane time constant of the second population << that of primary population
        do this with bounce_euler_alpha = 'instant'
    ...
    ** fineprint: no it's not quite recovered... TODO: explain this!
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.sample_ambient_dims = self.sample_ambient_dims * 2
    ...
    def denoise_one_step(self, t_idx: int, x_t_plus_1: _T, predicted_residual: _T, noise_scaler: float):
        ...
        This should make it clear why bounce_euler_alpha = 'instant' does not quite recover 2 layer nn case!
        """
        ...
        import pdb; pdb.set_trace(header = 'stack shapes!')
        return torch.stack([x_t_primary, x_t_bounce], -2), torch.stack([x0_pred_primary, x0_pred_bounce], -2)
    ...
    def tf_replace(self, one_step_denoising: _T, ts_embedded_samples) -> _T:
        ...
        new_one_step_denoising[...,0,:] = new_one_step_denoising[...,0,:] + ts_embedded_samples
...
class PreparatoryBounceNetworkHVAEReverseProcess(
    ...
    def __init__(self, *_, seperate_output_neurons: bool, primary_euler_alpha: float, bounce_euler_alpha: float | Literal['instant'], sample_ambient_dim: int, sample_shape: List[int], sigma2xt_schedule: _T, residual_model: VectoralResidualModel, input_model: InputModelBlock, time_embedding_size: int, noise_scaler: float, train_as_rnn: bool, device="cuda", **kwargs) -> None:
        super().__init__(
            num_prep_steps=None,
